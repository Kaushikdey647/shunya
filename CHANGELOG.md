...
- **HTTP API doc:** dedicated [**Universe return analytics**](https://kaushikdey647.github.io/shunya/http-api/#universe-return-analytics) section (query table + UI cross-link). [Studio → Universes / Risk & structure](https://kaushikdey647.github.io/shunya/ui/studio/#risk-structure-tab) expanded with a **Risk & structure** subsection (tab behavior).

- **Documentation:** [Reference → HTTP API package (`api/`)](https://kaushikdey647.github.io/shunya/reference/http-api-package/) (`docs/reference/http-api-package.md`) — OpenAPI **`/docs`** / **`/redoc`** / **`/openapi.json`**, **`curl`** export, **`api/`** source layout; linked from [Reference](https://kaushikdey647.github.io/shunya/reference/), [HTTP API](https://kaushikdey647.github.io/shunya/http-api/), docs home map, and MkDocs **Reference** nav.
